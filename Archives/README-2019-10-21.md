...
- [effectivescala](https://github.com/twitter-archive/effectivescala) - Twitter's Effective Scala Guide
...
- [raw](https://github.com/rawgraphs/raw) - We launched a crowdfunding campaign to develop a brand new version of RAWGraphs
...
- [rax](https://github.com/alibaba/rax) - The fastest way to build universal application. （快速构建多端应用）https://rax.js.org
...
- [Formality-Net-Animator](https://github.com/moonad/Formality-Net-Animator) - Animations for Elementary-Affine-Net interactions
...
- [uamp](https://github.com/android/uamp) - This sample shows how to implement an audio media app that works across multiple form factors and provide a consistent user experience on Android phones, tablets, Auto, Wear and Cast devices
...
- [hol-light](https://github.com/jrh13/hol-light) - The HOL Light theorem prover (moved from Google code)
...
- [awesome-resume-for-chinese](https://github.com/dyweb/awesome-resume-for-chinese) - 适合中文的简历模板收集（LaTeX，HTML/JS and so on）由 @hoodiearon 维护
...
- [Whitepaper](https://github.com/moonad/Whitepaper) - Moonad: a Peer-to-Peer Operating System
...
- [Formality-Base](https://github.com/moonad/Formality-Base) - Standard library for the Formality language
...
- [emu](https://github.com/calebwin/emu) - an accelerator for Rust
...
- [plotters](https://github.com/38/plotters) - A rust drawing library focus on data plotting for both WASM and native applications 🦀 📈🚀
