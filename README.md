...
- [Base.fm](https://github.com/moonad/Base.fm) - Standard library for the Formality language
...
- [rust-raspi3-OS-tutorials](https://github.com/rust-embedded/rust-raspi3-OS-tutorials) - :books: Learn to write an embedded OS in Rust on the Raspberry Pi :crab:
...
- [emu](https://github.com/calebwin/emu) - Emu is a framework for developing safe, robust GPU-accelerated applications in Rust.
...
- [benchmarks](https://github.com/ballista-compute/benchmarks) - Benchmarks comparing the performance of Apache Spark and DataFusion for aggregate queries on NYC trip data.
