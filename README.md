...
## Contents
  ...
  - [Julia (69)](#julia-69)
  - [Jupyter Notebook (88)](#jupyter-notebook-88)
  - [Kotlin (16)](#kotlin-16)
  - [LLVM (1)](#llvm-1)
...
- [AirSim](https://github.com/microsoft/AirSim) - News: We're hosting a drone racing competition this Neurips. Click on link --&gt;
...
- [fviz](https://github.com/asmuth/fviz) - fviz is a text-based data visualization program
...
- [paddle-mobile](https://github.com/PaddlePaddle/paddle-mobile) - Multi-platform embedded deep learning framework (『飞桨』多平台高性能嵌入式深度学习框架）
...
- [deepdetect](https://github.com/jolibrain/deepdetect) - Deep Learning API and Server in C++11 support for Caffe, Caffe2, Dlib, NCNN, Tensorflow, XGBoost and TSNE
...
- [acra](https://github.com/cossacklabs/acra) - Database encryption proxy for data-driven apps: strong selective encryption, SQL injections prevention, intrusion detection, honeypots.
...
- [mafsa](https://github.com/smartystreets/mafsa) - Package mafsa implements Minimal Acyclic Finite State Automata in Go, essentially a high-speed, memory-efficient, Unicode-friendly set of strings.
...
- [hospitalrun.github.io](https://github.com/HospitalRun/hospitalrun.github.io) - Informational site for the HospitalRun software. Powered by GitHub Pages and Jekyll.
...
- [failsafe](https://github.com/jhalterman/failsafe) - Failure handling and resilience patterns for the JVM
...
- [is.js](https://github.com/pwnn/is.js) - Minimalistic predicate library.
...
- [Origami](https://github.com/robbykraft/Origami) - planar graph library for representing crease patterns and performing origami operations
...
- [mxfactorial](https://github.com/systemaccounting/mxfactorial) - Combinatorial Game Theory through Conformal Geometric Algebra
...
- [dc2](https://github.com/mikesteele/dc2) - 👷 A rewrite of dual-captions with simplified adapter API [WIP]
...
- [Grassmann.jl](https://github.com/chakravala/Grassmann.jl) - ⟨Grassmann-Clifford-Hestenes-Leibniz⟩ differential conformal geometric algebra of multivector forms
...
- [awesome-libra](https://github.com/learndapp/awesome-libra) - :octocat: A Curated List of Awesome Facebook Libra Resources, welcome to add issues and create pull request. 欢迎国内的朋友
...
- [Railscast-VSCode](https://github.com/PaulOlteanu/Railscast-VSCode) - (Beautiful) Syntax theme for VSCode
...
- [30-seconds-of-python-code](https://github.com/30-seconds/30-seconds-of-python-code) - A curated collection of useful Python snippets that you can understand in 30 seconds or less.
...
- [zhihu-analysis-python](https://github.com/simoncos/zhihu-analysis-python) - Data analysis of Zhihu with Python
...
- [rouge](https://github.com/rouge-ruby/rouge) - A pure-ruby code highlighter that is compatible with pygments http://rouge.jneen.net/
...
- [espeak-http](https://github.com/dejan/espeak-http) - Micro web app for Text-To-Speech conversion via HTTP powered by Ruby, Sinatra, lame, espeak and espeak-ruby.
...
- [emu](https://github.com/calebwin/emu) - a language for programming GPUs
...
- [sozu](https://github.com/sozu-proxy/sozu) - Sōzu HTTP reverse proxy, configurable at runtime, fast and safe, built in Rust. It will be awesome when it will be ready. Not So Secret Project! Ping us on gitter to know more
...
- [bao](https://github.com/oconnor663/bao) - a general-purpose tree hash for files
...
- [rust-base64](https://github.com/alicemaz/rust-base64) - base64, in rust
...
- [abstreet](https://github.com/dabreegster/abstreet) - A traffic simulation game exploring how small changes affect cyclists, transit users, pedestrians, and drivers.
...
- [cargo-local-registry](https://github.com/alexcrichton/cargo-local-registry) - A cargo subcommand to manage local registries
...
- [metrics](https://github.com/metrics-rs/metrics) - high-quality, batteries-included metrics library for Rust
...
- [cargo-play](https://github.com/fanzeyi/cargo-play) - Running your Rust code file without manually setting up a Cargo project.
...
- [mtcnn](https://github.com/cetra3/mtcnn) - Tensorflow Rust Implementation of MTCNN
...
- [esta](https://github.com/epellis/esta) - Gradually typed, interpreted language of my own design written in Rust
...
- [iterm2-zmodem](https://github.com/luxihk/iterm2-zmodem) - Automatic ZModem support for iTerm 2
