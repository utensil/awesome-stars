...
## Contents
  ...
  - [Java (304)](#java-304)
  - [JavaScript (1801)](#javascript-1801)
  - [Julia (93)](#julia-93)
  - [Jupyter Notebook (104)](#jupyter-notebook-104)
  - [Kotlin (19)](#kotlin-19)
  - [LLVM (1)](#llvm-1)
  - [Lean (55)](#lean-55)
  - [Less (2)](#less-2)
...
- [density](https://github.com/k0dai/density) - Superfast compression library
...
- [cpp.react](https://github.com/snakster/cpp.react) - C++React: A reactive programming library for C++11.
...
- [precss](https://github.com/csstools/precss) - Use Sass-like markup in your CSS
...
- [sonar-cxx](https://github.com/SonarOpenCommunity/sonar-cxx) - SonarQube C++ Community plugin (cxx plugin): This plugin adds C++ support to SonarQube with the focus on integration of existing C++ tools.
...
- [perfect-scrollbar](https://github.com/mdbootstrap/perfect-scrollbar) - Minimalistic but perfect custom scrollbar plugin. Get more free components with Material Design for Bootstrap UI Kit (link below)
...
- [phenomic](https://github.com/MoOx/phenomic) - DEPRECATED. Please use Next.js instead.
...
- [minigrid](https://github.com/hnqlvs/minigrid) - 📏 Minimal 2kb zero dependency cascading grid layout
...
- [postcss-modules](https://github.com/madyankin/postcss-modules) - PostCSS plugin to use CSS Modules everywhere
...
- [node-draftlog](https://github.com/ivanseidel/node-draftlog) - 📜 Create mutable log lines into the terminal, and give life to your logs!
...
- [Fiber](https://github.com/LinkedInAttic/Fiber) - Lightweight JavaScript prototypal inheritance model
...
- [abi-stable-node](https://github.com/nodejs/abi-stable-node) - Repository used by the Node-API team to manage work related to Node-API and node-addon-api
...
- [example-node-and-browser-qunit-ci](https://github.com/Krinkle/example-node-and-browser-qunit-ci) - Example project with continuous integration for linting and cross-browser testing of isomorphic JavaScript.
...
- [Railscasts-Renewed](https://github.com/PaulOlteanu/Railscasts-Renewed) - Syntax theme for VSCode
...
- [METADATA.jl](https://github.com/JuliaLang/METADATA.jl) - Metadata for registered Julia packages up to Julia v0.6. No longer maintained.
...
- [Clang.jl](https://github.com/JuliaInterop/Clang.jl) - Julia interface to libclang
...
- [Leibniz.jl](https://github.com/chakravala/Leibniz.jl) - Tensor algebra utility library
- [InfixFunctions.jl](https://github.com/HarmonicaMuse/InfixFunctions.jl) - Julia infix function hack.
...
- [free-for-dev-zh](https://github.com/tvvocold/free-for-dev-zh) - 国内免费开发工具/服务清单
...
- [concise-encoding](https://github.com/kstenerud/concise-encoding) - The friendly data format for human and machine. Ad-hoc, secure, with 1:1 compatible twin binary and text formats and rich type support.
...
- [Chevereto-Free](https://github.com/Chevereto/Chevereto-Free) - Community/Personal Image Sharing powered by Chevereto.
...
- [Theano](https://github.com/Theano/Theano) - Theano was a Python library that allows you to define, optimize, and evaluate mathematical expressions involving multi-dimensional arrays efficiently. It is being continued as aesara: www.github.com/pymc-devs/aesara
...
- [thepast](https://github.com/laiwei/thepast) - thepast.me ｜ 个人杂志计划
...
- [pron_dictionaries](https://github.com/Kyubyong/pron_dictionaries) - pronunciation dictionaries for multiple languages
...
- [aasm](https://github.com/aasm/aasm) - AASM - State machines for Ruby classes (plain Ruby, ActiveRecord, Mongoid, NoBrainer, Dynamoid)
...
- [BooJS](https://github.com/seosgithub/BooJS) - Unix swiss army knife for headless browser javascript
...
- [rustsec](https://github.com/RustSec/rustsec) - Audit Cargo.lock files for dependencies with security vulnerabilities
...
- [elan](https://github.com/leanprover/elan) - A Lean version manager
...
- [wxwork_robotd](https://github.com/owent/wxwork_robotd) - 微信机器人接入服务
...
- [functions.netlify.com](https://github.com/netlify/functions.netlify.com) - Tutorials, examples, workshops and a playground for serverless with Netlify Functions
...
- [slick](https://github.com/slick/slick) - Scala Language Integrated Connection Kit. Slick is a modern database query and access library for Scala
...
- [carbondata](https://github.com/apache/carbondata) - High performance data store solution
...
- [NativeScript](https://github.com/NativeScript/NativeScript) - NativeScript empowers you to access native api's from JavaScript directly. Angular, Capacitor, Ionic, React, Svelte, Vue and you name it compatible.
...
- [PptxGenJS](https://github.com/gitbrent/PptxGenJS) - Create PowerPoint presentations with a powerful, concise JavaScript API.
...
- [texterify](https://github.com/texterify/texterify) - The localization management system.
...
- [openipa-old](https://github.com/hfellerhoff/openipa-old) - A free, fast, community-focused transcription tool to transcribe texts in Latin, French, German, and Italian into IPA.
