...
- [transformer-xl-chinese](https://github.com/GaoPeng97/transformer-xl-chinese) - transformer xl在中文文本生成上的尝试（效果意外的好，可写小说、古诗）（transformer xl for text generation of chinese）
