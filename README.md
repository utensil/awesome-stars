...
- [Formality](https://github.com/moonad/Formality) - A modern proof language
...
- [dnsdiff](https://github.com/joshenders/dnsdiff) - A DNS migration tool that helps you verify successful configuration on a new provider
