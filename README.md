...
- [rplibs](https://github.com/refscn/rplibs) - Refs.cn 原型设计元件库，基于Axure RP 8，支持 Android、Apple、Windows、微信，移动、桌面平台的应用和网站原型设计。
...
- [quadtree2.js](https://github.com/p1100i/quadtree2.js) - A region based, two dimensional quadtree implementation in JavaScript.
...
- [sketches-core](https://github.com/DataSketches/sketches-core) - Core Java Sketch Library.
...
- [rax](https://github.com/alibaba/rax) - [ 🚧Work In Progress v1.0] The fastest way to build universal application.
...
- [doubanj](https://github.com/ktmud/doubanj) - Visualization of your reading history.
...
- [calque](https://github.com/grimalschi/calque) - Improved calculator
...
- [miniprogram-gifmaker](https://github.com/planet0104/miniprogram-gifmaker) - 微信小程序GIF动画制作
...
- [Grassmann.jl](https://github.com/chakravala/Grassmann.jl) - Conformal geometric product algebra based on static dual multivectors with graded-blade indexing
...
- [models](https://github.com/onnx/models) - The ONNX Model Zoo is a collection of pre-trained, state-of-the-art models in the ONNX format
...
- [GAN-auto-write](https://github.com/aalind0/GAN-auto-write) - Generative Adversarial Network that learns to generate handwritten digits.
...
- [awesome-activerecord](https://github.com/planetruby/awesome-activerecord) - A collection of awesome ActiveRecord goodies, libraries, tools, extensions, guides, etc.
...
- [blade-build](https://github.com/chen3feng/blade-build) - Build system of tencent, support C/C++/Java/Scala/Python/go/protobuf/thrift/lex-yacc/swig...
...
- [dupeguru](https://github.com/hsoft/dupeguru) - Find duplicate files
...
- [baseline](https://github.com/dpressel/baseline) - Strong Deep-Learning Baseline algorithms for NLP
...
- [Tikz](https://github.com/walmes/Tikz) - Art with Tikz
- [aRxiv](https://github.com/ropensci/aRxiv) - Programmatic interface to the Arxiv API
- [lyrics](https://github.com/Lyrics/lyrics) - :page_facing_up: The Open Lyrics Database
...
- [BotBuilder](https://github.com/Microsoft/BotBuilder) - Bot Builder provides the most comprehensive experience for building conversation applications
...
- [rouge](https://github.com/jneen/rouge) - A pure-ruby code highlighter that is compatible with pygments http://rouge.jneen.net/
...
- [wasmer](https://github.com/wasmerio/wasmer) - Universal Binaries Powered by WebAssembly
...
- [glutin](https://github.com/tomaka/glutin) - Pure Rust alternative to GLFW
...
- [notion](https://github.com/notion-cli/notion) - Notion: the hassle-free JavaScript toolchain manager
- [hashbrown](https://github.com/Amanieu/hashbrown) - Rust port of Google's SwissTable hash map
...
- [holochain-rust](https://github.com/holochain/holochain-rust) - The core Holochain framework written in Rust, a container API for that (with rust and node implementations), and hdk-rust library for Zomes
...
- [rust-raspi3-OS-tutorials](https://github.com/rust-embedded/rust-raspi3-OS-tutorials) - :books: Rust bare-metal and OS tutorials on the Raspberry Pi 3
...
- [whatlang-rs](https://github.com/greyblake/whatlang-rs) - Natural language detection library for Rust
...
- [torchbear](https://github.com/foundpatterns/torchbear) - 🔥🐻 A fast, simple, and complete interpreter for Speakeasy
...
- [rust_graphql_api_boilerplate](https://github.com/mattdamon108/rust_graphql_api_boilerplate) - A Boilerplate of GraphQL API built with Rust + Warp + Juniper + Diesel
...
- [debug-here](https://github.com/ethanpailes/debug-here) - A rust debugger hook for linux and macos
...
- [thank](https://github.com/brown121407/thank) - Find out who to thank for the 📦s you use every day
...
- [Pine](https://github.com/lukakerr/Pine) - A modern, native macOS markdown editor - themeable, tabs, sidebar, github flavored markdown, exporting, latex and more
...
- [zig](https://github.com/ziglang/zig) - robust, optimal, and clear programming language
